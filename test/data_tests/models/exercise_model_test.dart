...
void main() {
  group('Ejercicio Model Tests - Dependencia Intermedia', () {
    ...
    test(
      'fromJson debe mapear correctamente la estructura relacional anidada de Supabase',
      () {
    ...
    test('toMap debe exportar solo la tabla base para inserciones', () {
      ...
      expect(
        mapa.containsKey('categorias'),
        isFalse,
      ); // Las relaciones van en otra tabla
    });
  });
}
