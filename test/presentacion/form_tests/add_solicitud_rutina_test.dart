...
void main() {
  group('AddSolicitudRutinaForm Tests', () {
    ...
    testWidgets(
      'debe mostrar advertencia si el alumno es deudor y permite cancelar',
      (tester) async {
        ...
        expect(
          find.textContaining(
            'El alumno se encuentra en situación de deudor (hace 10 días).',
          ),
          findsOneWidget,
        );
        expect(
          find.textContaining('¿Desea continuar de todas formas?'),
          findsOneWidget,
        );
    ...
    testWidgets(
      'debe mostrar advertencia si no tiene pagos y permite continuar',
      (tester) async {
        SolicitudRutina? guardado;
        await tester.pumpWidget(
          createWidgetUnderTest(onGuardar: (d) => guardado = d),
        ...
        expect(find.text('Advertencia'), findsOneWidget);
        expect(
          find.textContaining('El alumno no registra pagos.'),
          findsOneWidget,
        );
        expect(
          find.textContaining('¿Desea continuar de todas formas?'),
