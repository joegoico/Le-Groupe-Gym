...
void main() {
  group('Sidebar Business Logic Tests - Filtros Base', () {
    ...
    test(
      'Al aplicar un filtro por grupo muscular, la lista filtrada solo debe contener ejercicios de ese grupo',
      () {
        ...
        expect(
          controller.filteredExercises.any(
            (e) => e.nombre == 'Sentadilla Libre',
          ),
          isFalse,
        );
    ...
    test(
      'Al escribir en el buscador, debe filtrar ignorando mayúsculas y minúsculas',
      () {
        final controller = SidebarController(allExercises: listaMock);
    ...
    // ==========================================
    test(
      'getSubgroupsForSelected debe retornar vacío si no hay ningún grupo seleccionado',
      () {
        final controller = SidebarController(allExercises: listaMock);
    ...
    test(
      'getSubgroupsForSelected debe retornar los subgrupos correctos al activar un grupo',
      () {
    ...
    test(
      'availableMuscleGroups debe retornar los grupos derivados de los ejercicios',
      () {
        // Arrange
        final controller = SidebarController(allExercises: listaMock);
    ...
    test(
      'Regla de negocio: Al desmarcar un grupo principal se deben limpiar sus subgrupos asociados',
      () {
        final controller = SidebarController(allExercises: listaMock);
