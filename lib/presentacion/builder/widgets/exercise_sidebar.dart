  ...
  Widget build(BuildContext context) {
      return ListenableBuilder(
        ...
        builder: (context, _) {
          ...
          final activeFiltersCount = _controller.selectedMuscleGroups.length + 
          ...
          child: Column(
            children: [
              ...
              ListenableBuilder(
                listenable: widget.controller,
                builder: (context, _){
                  if (widget.controller.isSelectingForCombine) return SizedBox.shrink();
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              widget.controller.isSelectingForCombine != null
                                  ? 'Combinar con "${widget.controller.combiningTargetExerciseName}" — tocá + en un ejercicio'
                                  : 'Modo combinar — tocá + en un ejercicio de la lista',
