          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    widget.precio == null ? 'Registrar Nuevo Plan' : 'Editar Plan',
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _FieldLabel('Duración (días)', icon: Icons.calendar_today),
                  const SizedBox(height: AppSpacing.xs),
                  SizedBox(
                    height: 44,
                    child: TextFormField(
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: Text(
                              _isLoading ? 'Guardando...' : (widget.precio == null ? 'Crear Plan' : 'Guardar'),
